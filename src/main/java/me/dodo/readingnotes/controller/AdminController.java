...
public class AdminController {
    ...
    public ApiResponse<AdminBookStatsResponse> getBookStats() {
    ...
    public ApiResponse<AdminRecordStatsResponse> getStats() {
    ...
    public ApiResponse<Map<String, Integer>> cleanAllSentences() {
    ...
    @PostMapping("/notice")
    public ApiResponse<NoticeResponse> createNotice(@RequestBody NoticeUpdateRequest body) {
